...
function openOverlay(url) {
    ...
    // 1. Inietta l'intera struttura HTML nel DOM in un solo passaggio
    ...
    // Chiudi cliccando fuori o sulla "X" (Event Delegation)
        ...
        .catch(() => {
            content.innerHTML = `
                <div class="text-center py-6">
                    ...
                    <p class="text-neutral-500 text-xs mt-1">Impossibile caricare il percorso: ${url}</p>
                </div>`;
        });
}
