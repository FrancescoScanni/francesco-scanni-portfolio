    ...
    <?php if (isset($_SESSION['success'])): ?>
        ...
        <?php if ($_SESSION['success'] === true): ?>
            <div class="fixed top-6 right-6 z-50 max-w-sm w-full bg-white rounded-2xl border border-slate-100 shadow-xl p-4 flex items-start gap-3 transition-all duration-300">
                ...
                <div class="flex-1">
                    <p class="text-sm font-extrabold text-[#1B1B1B] tracking-tight">Messaggio inviato!</p>
                    <p class="text-xs text-slate-400 mt-0.5 font-medium">Ti risponderò il prima possibile.</p>
                </div>
        ...
        <?php else: ?>
            <div class="fixed top-6 right-6 z-50 max-w-sm w-full bg-white rounded-2xl border border-slate-100 shadow-xl p-4 flex items-start gap-3 transition-all duration-300">
                ...
                <div class="flex-1">
                    <p class="text-sm font-extrabold text-[#1B1B1B] tracking-tight">Invio fallito</p>
                    <p class="text-xs text-slate-400 mt-0.5 font-medium">Riprova o scrivimi direttamente via mail.</p>
                </div>
