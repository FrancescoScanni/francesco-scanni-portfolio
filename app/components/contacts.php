...
<div id="contTitle" class="contMe raleway text-white text-[40px] font-black mb-4">Contattami</div>
            ...
            <form action="components/cont.php" method="POST" id="formContacts" class="inputSet w-full max-w-md flex flex-col gap-6 bg-[#111111] p-8 rounded-2xl shadow-2xl">
                <div class="inputItem w-full">
                    ...
                    <input name="mail" class="w-full h-[44px] px-4 rounded bg-[#F8F8F8] border border-transparent focus:border-[#62BA1B] text-[#333] font-normal ibm text-[14px] outline-none transition-colors" type="email" placeholder="Inserisci la tua email" />
                </div>
                <div class="inputItem w-full">
                ...
                <div class="inputItem w-full">
                    ...
                    <textarea name="message" class="w-full h-[140px] px-4 py-3 rounded bg-[#F8F8F8] border border-transparent focus:border-[#62BA1B] text-[#333] font-normal ibm text-[14px] outline-none resize-none transition-colors" placeholder="Scrivi qui il tuo messaggio" ></textarea>
                </div>
