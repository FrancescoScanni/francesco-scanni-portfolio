<?php 
    ...
    $header = '<div class="header w-full h-[70px] bg-[#1B1B1B] flex justify-between items-center px-6 z-40 lg:fixed lg:top-0 lg:left-1/2 lg:-translate-x-1/2 lg:w-[86%] lg:max-w-7xl lg:rounded-b-[8px] lg:px-12">
                    ...
                    <div class="relative flex justify-end lg:hidden">
                        <nav id="menu" class="gap-[20px] fixed w-full left-0 top-[70px] p-6 hidden flex-col h-[calc(100vh-70px)] bg-gradient-to-b from-[#080808] to-[#111111] z-40 shadow-2xl">
                            <div class="redirItem flex items-center justify-between">
                                <a href="#features"><p class="text-[#9C9C9C] raleway text-[24px] font-extrabold">Projects</p></a>
                            ...
                            <div class="redirItem flex items-center mt-2">
                                <a href="#features"><p class="text-[#9C9C9C] raleway text-[24px] font-extrabold">Articles</p></a>
                            </div>
                            <div class="redirItem flex items-center mt-2">
                    ...
                    <div class="hidden lg:flex lg:gap-[50px] xl:gap-[70px] items-center">
                        <a href="../../../index.php" onclick="scrollWithOffset(event, \'mySection\')"><p class="text-[#9C9C9C] hover:text-white transition-colors ibm text-[14px] tracking-[0.14px]">About me</p></a>
                        <a href="../pcto/pcto.html"><p class="text-[#9C9C9C] hover:text-white transition-colors ibm text-[14px] tracking-[0.14px]">Experiences</p></a>
                        <a href="../../../index.php#contacts"><p class="text-[#9C9C9C] hover:text-white transition-colors ibm text-[14px] tracking-[0.14px]">Contacts</p></a>
                    </div>
    ...
    $info = '<section class="max-w-6xl mx-auto px-6 pt-18 pb-20 md:pt-48 md:pb-32">
                <div class="max-w-3xl">
                    ...
                    <p class="font-mono text-gray-600 text-lg md:text-xl leading-relaxed border-l-4 border-gray-300 pl-6">
                        A collection of the work I have created, from initial ideas to the final product. Code, creativity, and problem-solving.
                    </p>
                </div>
            </section>';
    ...
    $prefooter = '<section class="flex justify-end max-w-6xl mx-auto px-6 pt-18 pb-20 md:pb-32">
                <div class="max-w-3xl">
                    ...
                    <p class="font-mono text-gray-600 text-lg md:text-xl leading-relaxed border-l-4 border-gray-300 pl-6">
                        Discover other projects and work I have completed. Click the link below to visit my GitHub profile to view the source code and project repositories.
                    </p>
